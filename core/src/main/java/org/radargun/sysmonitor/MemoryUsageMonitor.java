...
public class MemoryUsageMonitor extends JmxMonitor {
   ...
   public synchronized void run() {
      try {
         ...
         timeline.addEvent(Timeline.Category.sysCategory(MEMORY_USAGE), new Timeline.ValueEvent(mem.getUsed() / 1048576));
   ...
   public synchronized void start() {
      super.start();
      timeline.addEvent(Timeline.Category.sysCategory(MEMORY_USAGE), new Timeline.ValueEvent(0));
   }
