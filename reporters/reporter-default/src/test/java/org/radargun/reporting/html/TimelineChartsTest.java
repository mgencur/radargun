...
public class TimelineChartsTest {
   ...
   public void test() {
      ...
      t0.addEvent("Category A", new Timeline.ValueEvent(now + 1000, 10));
      t0.addEvent("Category A", new Timeline.ValueEvent(now + 2000, 5));
      t0.addEvent("Category A", new Timeline.ValueEvent(now + 3000, 8));
      t0.addEvent("Category A", new Timeline.ValueEvent(now + 4000, 12));

      t1.addEvent("Category A", new Timeline.ValueEvent(now + 1000, 13));
      t1.addEvent("Category A", new Timeline.ValueEvent(now + 2000, 15));
      t1.addEvent("Category A", new Timeline.ValueEvent(now + 4000, 5));
      ...
      t0.addEvent("Category C", new Timeline.ValueEvent(now + 1000, 600));
      t0.addEvent("Category C", new Timeline.ValueEvent(now + 2500, 800));
      t0.addEvent("Category C", new Timeline.ValueEvent(now + 3100, 2000));
      t0.addEvent("Category C", new Timeline.ValueEvent(now + 4000, 1200));

      t1.addEvent("Category C", new Timeline.ValueEvent(now + 1200, 513));
      t1.addEvent("Category C", new Timeline.ValueEvent(now + 2100, 912));
      t1.addEvent("Category C", new Timeline.ValueEvent(now + 3800, 485));
